...
import com.brodyagi.hopit.domain.Country;
import com.brodyagi.hopit.repository.CountryRepository;
...
/**
 * REST controller for managing {@link com.brodyagi.hopit.domain.Country}.
 */
@RestController
@RequestMapping("/api")
@Transactional
