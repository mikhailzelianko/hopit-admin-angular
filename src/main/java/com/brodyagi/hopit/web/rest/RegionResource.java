...
import com.brodyagi.hopit.domain.Region;
import com.brodyagi.hopit.repository.RegionRepository;
...
/**
 * REST controller for managing {@link com.brodyagi.hopit.domain.Region}.
 */
@RestController
@RequestMapping("/api")
@Transactional
